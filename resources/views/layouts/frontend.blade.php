  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> Apotek-k24@gmail.com</li>
          <li>Free Shipping for all Order of Rp 99</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address:  Jl. Pahlawan Revolusi, RT.1/RW.4, Pd. Bambu, Kecamatan Duren
                  Sawit, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13430</li>
                <li>Phone: +62 218-8999-1209</li>
                <li>Email: Apotek-k24@gmail.com</li>
              </ul>
            </div>
          </div>
            ...
            <div class="footer__copyright">
              <div class="footer__copyright__text">
                <p>
                  ...
                  <a href="https://colorlib.com" target="_blank">wanikh</a>
                  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
              </div>
